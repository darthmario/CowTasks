...
_APP_Support_URL = 'http://forums.precentral.net/homebrew-apps/220603-remember-milk-rtm-app.html';   // label = “Support Website”
        // label = “Send Email”
//_APP_Support_Phone = '555-555-5555'        // label = _APP_Support_Phone

/*
// Optional
//_APP_Publisher_URL = 'URL' // label = _APP_PublisherName + “Website”
_APP_Help_Resource = [
					 	{ type: 'web', label: 'Make a Donation'}
