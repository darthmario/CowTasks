...
(function(){
 ...
 : function(node, _25b){
            ...
            var _262 = d.isIE ? "styleFloat" : "cssFloat", _263 = {
                "cssFloat": _262,
                "styleFloat": _262,
                "float": _262
            };
            ...
            var _2e8 = {}, _ctr = 0, _2ea = dojo._scopeName + "attrid", _2eb = {
                col: 1,
                colgroup: 1,
                table: 1,
                tbody: 1,
    ...
    if (!dojo._hasResource["dojo._base.NodeList"]) {
        ...
        (function(){
            ...
            dojo.extend(dojo.NodeList, {
                ...
                coords: _329(d.coords),
                place: function(_34a, _34b){
 ...
 : function(cond){
            ...
            var _41c = function(_41d){
                ...
                if (!oper) {
                    if (_41d.id) {
                        _421 = (!_41d.loops && _423) ? _371 : _3e0(_41d, {
                            el: 1,
                            id: 1
                        });
 ...
 : function(){
            ...
            dojo._fade = function(args){
                ...
                var _513 = _4f3({
                    properties: {}
                }, args), _514 = (_513.properties.opacity = {});
